...
<div class="wrap">
	...
	<h2><?php _e( 'WP Modal Popup with Cookie Integration - Features', 'wp-modal-popup-with-cookie-integration' ); ?></h2><br />	
	...
	<table class="wpos-plugin-pricing-table">
		...
		<colgroup></colgroup>	
	     <thead>
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>WP Modal Popup with Cookie Integration</strong> and <strong>all other products</strong> with a single purchase.</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>WP Modal Popup with Cookie Integration</strong> and <strong>all other products</strong> with a single purchase.</p>
	    ...
	    <tbody>
	    	...
	    	<tr>
	    		...
	    		<td>2</td>
	    		<td>10+ predefined layouts</td>
	    	</tr>

	    	<tr>
		    	<th>Create Unlimited Popups <span> You can create Unlimited Popups</span></th>
		    	<td><i class="dashicons dashicons-no-alt"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	<tr>
		    	<th>Popup positions<span> Diffrent Popup position available </span></th>
		    	<td><i class="dashicons dashicons-no-alt"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	
	    	<tr>
		    	<th>Insert your pop-up into any page or a post<span> You can set pop-up for any page or a post</span></th>
		    	<td><i class="dashicons dashicons-no-alt"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	<tr>
		    	<th>Page level Targeting<span>Page level Targeting (different popups for each post/page, turn popup on/off for all page or for few pages/posts)</span></th>
		    	<td><i class="dashicons dashicons-no-alt"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	<tr>
		    	<th> Add any Video, HTML, iFrame, Shortcode of any plugin to display on popup.<span> You can Add any Video, HTML, iFrame, Shortcode of any plugin to display on popup.</span></th>
		    	<td><i class="dashicons dashicons-yes"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	<tr>
		    	<th> Customize the look and feel of the popup<span> You can Customize the look and feel of the popup</span></th>
		    	<td>Limited</td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	<tr>
		    	<th>Close button<span>Close button (show button: yes/no)</span></th>
		    	<td><i class="dashicons dashicons-yes"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	<tr>
		    	<th> Open Delay<span> Open Delay (open popup delay in seconds)</span></th>
		    	<td><i class="dashicons dashicons-yes"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	<tr>
		    	<th> Change popup content background color<span> You can Change popup content background color</span></th>
		    	<td><i class="dashicons dashicons-yes"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>

	    	<tr>
	    		<th>Customize popup overlay color and opacity <span>You can Customize popup overlay color and opacity</span></th>
	    		<td><i class="dashicons dashicons-no-alt"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>

			<tr>
	    		<th>Exit Intent! <span>You can create for when user try to exit</span></th>
	    		<td><i class="dashicons dashicons-no-alt"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	
			<tr>
	    		<th> Open when user scrolled XX% page!<span>Setting option for Open when user scrolled XX% page!</span></th>
	    		<td><i class="dashicons dashicons-no-alt"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>		
